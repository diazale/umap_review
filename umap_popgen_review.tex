...
Million Veterans Program (MVP) massive database, very genetically diverse. Ran UMAP on top 10 PCs and 15 NN  and mindist of 0.1 to visualize the genetic diversity in the data. Used UMAP to characterize the population ethnicity, in combination with PCA and Admixture.\cite{hunter-zinck_genotyping_2020}

Visualizing ancestral diversity in Latin-American populations, as groups can have overlapping/similar proportions of global ancestry but have different demographic histories.\cite{spear2020recent}
