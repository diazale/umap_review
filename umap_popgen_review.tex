...
Population structure is concentrated in subsets of the human genome, which can be thought of as restricted area of the larger genotype space -- this is why dimensionality reduction uncovers patterns. In some ways population structure may lie along a linear or nearly-linear subspace (e.g. relating to isolation-by-distance), and PCA can reveal such patterns. However, genetic variation may also be nonlinear, and this requires us to explore methods like approximating nonlinear manifolds.
